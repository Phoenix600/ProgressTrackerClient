...
async function createJavaCourse() {
  try {
    ...
    console.log(`🎯 Total Topics: ${javaCourseData.chapters.reduce((acc, chap) => acc + chap.topics.length, 0)}`);
    console.log(`⏱️  Total Duration: ${javaCourseData.chapters.reduce((acc, chap) => acc + chap.durationDays, 0)} days`);
    console.log('');
...
// Execute the course creation if this file is run directly
...
module.exports = { createJavaCourse, javaCourseData };